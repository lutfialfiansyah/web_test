                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" id="formregister">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" placeholder="628*********" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" required>
                            ...
                            <div class="col-md-6">
                                {{-- <input id="staff" type="staff" class="form-control{{ $errors->has('staff') ? ' is-invalid' : '' }}" name="staff" value="{{ old('staff') }}" required> --}}
